...
Step 3 - Configure Web Applications (See WEBAPP.jpeg). HSACCESS was already created but you can enable DeepSee and iKnow. iKnowCV is for Rest Service hosting. Make sure password authentication mode is checked.
